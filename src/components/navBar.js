        ...
        <div className="App mb-3">
            ...
            <div className="offcanvas offcanvas-start" tabIndex={-1} id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div className="offcanvas-body px-0 pt-0">
                    ...
                    <a className="rounded-0 btn hoverLink d-block ps-3 fs-5 border-0 link-offset-2 link-underline link-underline-opacity-0" href="/home/minha/conta"><i className="bi bi-folder-fill me-2"></i>Meus Arquivos</a>
